...
#define temperature_topic "Rd1/temperature"
#define humidity_topic "Rd1/humidity"
...
void loop() {
  ...
  //   hstring = std::to_string(h);

  //  std::string hmsg(string(h));
  //  //string tmsg = string(t);
    ...
    client.publish("Rd1/humidity", hmsg);
    client.publish("Rd1/temperature", tmsg);
  }
}
